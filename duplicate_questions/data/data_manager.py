...
class DataManager():
    ...
    def get_train_data_from_file(self, filenames, min_count=1,
        ...
        output: returns a tuple of (instance_generator, train_size)
            This returns an infinite instance generator that outputs instances
            as generated by the as_training_data function of the underlying
            instance class. It also returns the size of the training set
            (length of the generator), which is useful for figuring out
            what # of steps in a epoch is.
        """
    ...
    def get_validation_data_from_file(self, filenames, max_instances=None,
        ...
        Returns
        -------
        output: returns a tuple of (instance_generator, val_size)
            This returns an infinite instance generator that outputs instances
            as generated by the as_training_data function of the underlying
            instance class. It also returns the size of the validation set
            (length of the generator), which is useful for figuring out
            what # of steps in a epoch is.
        """
    ...
    def get_test_data_from_file(self, filenames, max_instances=None,
        ...
        Returns
        -------
        output: returns a tuple of (instance_generator, test_size)
            This returns an instance generator that outputs instances
            as generated by the as_testing_data function of the underlying
            instance class. It also returns the size of the test set
            (length of the generator), which is useful for figuring out
            what # of steps in a epoch is. Note that the generator
            is _NOT_ infinite.
        """
